...
<div class="row-fluid">
    <div class="span10 offset1" >
        ...
        <ul>    
            ...
            <li><a href="../controlador/controlador-reportes.jsp?item=2">Reporte 2 - Reporte de Costos </a></li>
        </ul>
        <h4>Recursos</h4>
        <ul>
            <li><a href="../controlador/controlador-reportes.jsp?item=3">Reporte 3 - Reporte de Recursos por Campaña</a></li>
        </ul>
        <h4>Personal</h4>
        <ul>
